...
use App\Controller\Spaceship\SpaceshipMoveBottomController;
...
class SpaceshipMoveBottomActionTest extends AcceptanceTestBase
{
    private const ENDPOINT = '/move/%s/bottom';
    ...
    public function testMoveBottomSuccessResponse()
    {
        ...
        self::assertArrayHasKey(SpaceshipMoveBottomController::KEY_RESPONSE_STATUS, $responseData);
        self::assertArrayHasKey(SpaceshipMoveBottomController::KEY_RESPONSE_CANVAS, $responseData);
        self::assertEquals(SpaceshipMoveBottomController::RESPONSE_STATUS_MOVED,$responseData['status']);

        $canvas = $responseData[SpaceshipMoveBottomController::KEY_RESPONSE_CANVAS];
    ...
    public function testMoveBottomCollisionResponse()
    {
        $httpClient = $this->getBaseClient();
        $queryParams = [
